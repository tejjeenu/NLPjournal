$(document).ready(function(){
    ...
    //API call here
    $.get("http://192.168.1.83:5000/random", function(data, status){
      ...
      goalquoteslist = goalquotesraw.split(",-");
      learningquoteslist = learningquotesraw.split(",-");
      gratefulquoteslist = gratefulquotesraw.split(",-");
      goalkeywordslist = goalkeywordsraw.split(" ");
      learningkeywordslist = learningkeywordsraw.split(" ");
      gratefulkeywordslist = gratefulkeywordsraw.split(" ");
    ...
    $("#mh").click(function(){
      alert("the monthly highlights button was clicked");
      window.location.replace("https://www.tutorialrepublic.com/");
    });

    $("#ae").click(function(){
      alert("the add entry button was clicked");
    });

    $("#ve").click(function(){
      alert("the view entry button was clicked");
    });
});